                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
                        ...
                        <div className="lg:col-span-2 bg-gradient-to-br from-gray-900 to-gray-800 text-white p-6 rounded-2xl shadow-lg">
                            <div className="flex justify-between items-center mb-4">
                                <h2 className="text-base font-semibold">Leads Generated by Day</h2>
                            </div>
                        ...
                        <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-2xl shadow-lg">
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-[2fr,1fr,1fr] gap-4 text-sm text-gray-400 font-medium pb-3 border-b border-gray-700">
                                ...
                                {[
                                    ...
                                    >
                                        <span className="text-white text-base whitespace-nowrap overflow-hidden text-ellipsis">
                                            {item.name}
                                        </span>
                                        ...
                                        <div className="flex justify-end">
                                            <span className="bg-orange-500 text-white text-sm font-bold px-4 py-1 rounded-md">
                                                {item.sales}
                                            </span>
                                        </div>
                                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                            ...
                            <div className="space-y-3">
                                <button className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg text-sm font-medium text-gray-900 hover:bg-gray-50 transition">
                                    Create Page
                                </button>
                                <button className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg text-sm font-medium text-gray-900 hover:bg-gray-50 transition">
                                    Write New Article
